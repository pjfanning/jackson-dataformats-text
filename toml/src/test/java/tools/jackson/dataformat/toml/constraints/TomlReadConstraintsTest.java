...
public class TomlReadConstraintsTest extends TomlMapperTestBase
{
    ...
    public void testNameLengthWithinLimit() throws Exception
    {
        ...
        final String ok = "a".repeat(MAX_NAME_LEN);
        final String ok2 = "b".repeat(MAX_NAME_LEN);
        final String ok3 = "c".repeat(MAX_NAME_LEN);
        final String ok4 = "d".repeat(MAX_NAME_LEN);
        final String ok5 = "e".repeat(MAX_NAME_LEN);
        final String ok6 = "f".repeat(MAX_NAME_LEN);
    ...
    public void testNameLengthDoesNotApplyToValues() throws Exception {
        ...
        assertEquals(_longName(), n.get("a").stringValue());
    }

    private static String _longName() {
        return "k".repeat(MAX_NAME_LEN + 1);
    }
    ...
    {
        TomlMapper mapper = mapperWithDocLimit(100);
    ...
    {
        final String doc = "a = \"" + "x".repeat(MAX_DOC_LEN + 500) + "\"\n";
        TomlMapper mapper = mapperWithDocLimit(MAX_DOC_LEN);
        _verifyDocTooLong(() -> mapper.readTree(doc));
    }
